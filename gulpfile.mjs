...
export const fonts = () => {
  return gulp
    .src("src/fonts/**/*", { encoding: false }) // Копируем только новые или измененные файлы
    .pipe(gulp.dest("dist/fonts")); // Копируем без изменений
};
...
export const images = () => {
  return gulp
    .src("src/img/**/*", { encoding: false }) // Копируем только новые или измененные файлы
